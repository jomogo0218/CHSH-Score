  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-3 border-t border-line pt-4">
        <div>
          <p className="text-sm font-semibold text-ink">資源回收分類提醒</p>
        ...
        <a
          ...
          className="inline-flex rounded-lg bg-mint px-4 py-2 text-sm font-semibold text-white transition hover:bg-leaf"
        >
          開啟資源回收分類寶典（PDF）
        </a>
      </div>
