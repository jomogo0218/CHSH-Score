...
export const DEMO_INSPECTIONS: InspectionDoc[] = [
  {
    ...
    inspector_id: "admin",
    total_score: 95,
    summary_blog: "走廊與黑板出色，洗手台略有水漬，整體優良。",
    status: "pass",
  ...
  },
  {
    ...
    inspector_id: "admin",
    total_score: 82,
    summary_blog: "掃具擺放凌亂，走廊有飲料罐，請中午前改善。",
    status: "pending_fix",
  ...
  },
  {
    ...
    inspector_id: "admin",
    total_score: 90,
    summary_blog: "教室明亮整潔，垃圾桶已清空，繼續保持。",
    status: "pass",
  ...
  },
  {
    ...
    inspector_id: "admin",
    total_score: 78,
    summary_blog: "洗手台積水與落葉，地板有紙屑，列為待改善。",
    status: "pending_fix",
